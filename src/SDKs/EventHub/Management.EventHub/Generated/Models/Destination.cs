...
namespace Microsoft.Azure.Management.EventHub.Models
{
    ...
    public partial class Destination
    {
        ...
        /// <param name="dataLakeSubscriptionId">DataLake
        /// SubscriptionId</param>
        /// <param name="dataLakeAccountName">DataLake AccountName</param>
        /// <param name="dataLakeFolderPath">DataLake FolderPath</param>
        /// <param name="archiveNameFormat">Blob naming convention for archive,
        /// e.g.
        /// {Namespace}/{EventHub}/{PartitionId}/{Year}/{Month}/{Day}/{Hour}/{Minute}/{Second}.
        /// Here all the parameters (Namespace,EventHub .. etc) are mandatory
        /// irrespective of order</param>
        public Destination(string name = default(string), string storageAccountResourceId = default(string), string blobContainer = default(string), string dataLakeSubscriptionId = default(string), string dataLakeAccountName = default(string), string dataLakeFolderPath = default(string), string archiveNameFormat = default(string))
        {
            Name = name;
