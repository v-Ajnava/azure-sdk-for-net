...
namespace Microsoft.Azure.Management.ServiceBus
{
    ...
    public static partial class RulesOperationsExtensions
    {
            ...
            /// </param>
            public static RuleResource CreateOrUpdate(this IRulesOperations operations, string resourceGroupName, string namespaceName, string topicName, string subscriptionName, string ruleName, RuleResource parameters)
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<RuleResource> CreateOrUpdateAsync(this IRulesOperations operations, string resourceGroupName, string namespaceName, string topicName, string subscriptionName, string ruleName, RuleResource parameters, CancellationToken cancellationToken = default(CancellationToken))
            {
